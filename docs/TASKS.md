...
| 1（完了済み） | T03, T05, T13, T14 | T00（T13, T14は技術的な必須依存は無いが、内容が主要機能に左右されるため実質このウェーブ以降が現実的） |
| 1.5（完了済み） | T15（ノート/タスク詳細画面、新規） | T00／推奨: T03, T05 |
| 2 | T04, T06, T07, T08, T09, T10, T12 | T03 および/または T05（詳細は各タスクの「依存」欄）。T04, T06のUI部分・T07・T09・T11はT15完了により組み込み先が確保された |
| 3 | T11 | T03, T05, T06 |
